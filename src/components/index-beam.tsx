...
import { ObsidianLogo, XiaohongshuLogo } from './icons';
...
const Circle = forwardRef<HTMLDivElement, { className?: string; children?: React.ReactNode }>(({ className, children }, ref) => {
    return (
        <div ref={ref} className={cn('z-10 flex size-12 items-center justify-center rounded-full bg-content1 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]', className)}>
            {children}
        </div>
    );
});
...
export function AnimatedBeamMultipleOutput({ className }: { className?: string }) {
    ...
    return (
        <div className={cn('relative flex h-[400px] w-full items-center justify-center overflow-hidden rounded-lg p-10 md:shadow-xl', className)} ref={containerRef}>
...
const Icons = {
    ...
    xiaohongshuLogo: () => {
        return <XiaohongshuLogo size={47} />;
    },
    obsidianLogo: () => {
        return <ObsidianLogo size={47} />;
    },
    googleDocs: () => (
    ...
    user: () => (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" xmlns="http://www.w3.org/2000/svg">
...
export default AnimatedBeamMultipleOutput;
